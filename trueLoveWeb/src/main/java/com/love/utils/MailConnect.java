...
public class MailConnect extends BasicServlet{//注意：mycode是用户从前台输入的验证码
	public static boolean sendQQmail(HttpServletResponse response,String from_email,String pwd,String str,String code,String name){
		...
		try {
			...
			//邮件标题
			message.setSubject("真缘网注册验证码");
			message.setSentDate(new Date()); //设置时间

			String content="<span style=\"font-size:12px;font-weight:blod;font-family:'微软雅黑'\">尊敬的"+name+"，您好！：</span><br /><br />" +
					"<div style='width:800px'>&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-size:14px;font-family:'微软雅黑'\">" +
					"欢迎注册真缘网，您本次的注册验证码为 "+code+" 本验证码2分钟内有效，请尽快完成注册。期待您的加入！</span><br/><br /><span style=\"font-size:14px;font-family:'微软雅黑';float:right;\">"
							+ "真缘网技术部</span><br/><span style=\"font-size:14px;font-family:'微软雅黑';float:right;padding-right:10px;\">"+sdf.format(new Date())+"</span></div>";
			...
			//e.printStackTrace();//打印发送邮件时的异常信息
			//out(response,2);
			return false;
		}
		return true;
