...
<meta name="keywords"
	content="交友; 爱情; 婚姻; 婚介; 征婚; 交友中心; 世纪佳缘; 世纪家园; 复旦；小龙女;龚海燕;神经元; 上海交友; 北京交友; 广州交友; 杭州交友; 武汉交友;大连交友; 天津交友; 深圳交友; 南京交友;西安交友; 成都交友; 重庆交友; 厦门交友; 哈尔滨交友; 长春交友; 沈阳交友; 济南交友;" />
<meta name="description"
	content="世纪佳缘为单身白领提供婚恋征友服务，免费注册，免费发布、搜索征友信息。现有2900万会员，550万人已成功找到伴侣，规模大、征友效果好，是安全、纯净的婚恋交友平台。" />
<title>佳缘测试</title>
<link href="css/testYourLove/style.css-new" type="text/css"
	rel="stylesheet" />
<link href="css/testYourLove/activity_display.css-new" rel="stylesheet" />
<!--标准头尾 -->
</head>
<body>
	<!-- 导入导航栏 -->
	...
	<div style="clear:both;margin-top:16px;width:79%;background-color:#EEE;margin-left:136px;border-radius:15px;">
	<!--下面是模板头的代码 开始-->
	<!--<script type="text/javascript" src="js/head_white.js"></script>-->
	<!-- 头部图片 -->
	<div class="topbg">
		<img src="images/testYourLove/top1.jpg" alt="" /> <img
			src="images/testYourLove/top2.jpg" alt="" /> <img
			src="images/testYourLove/top3.jpg" alt="" />
	</div>
	<!--栏目开始-->
	<div class="program">
		<ul>
			...
			<li class="right_li">
				<div class="sign_up" style="position: relative">
					<div class="ad_common_icon ad_common_rt" style="right: 8px"></div>
			...
			<li>
				<div class="sign_up" style="position: relative">
					<div class="ad_common_icon ad_common_rt" style="right: 8px"></div>
					<img style="margin-left: -8px;"
						src="images/testYourLove/20110803024104686.jpg"
			...
			<li class="right_li">
				<div class="sign_up" style="position: relative">
					<div class="ad_common_icon ad_common_rt" style="right: 8px"></div>
					<img style="margin-left: -8px;"
						src="images/testYourLove/20120416015257192.jpg"
			...
			<li>
				<div class="sign_up" style="position: relative">
					<div class="ad_common_icon ad_common_rt" style="right: 8px"></div>
					<img style="margin-left: -8px;"
						src="images/testYourLove/20130529100328332.jpg"
			...
			<li class="right_li">
				<div class="sign_up" style="position: relative">
					<div class="ad_common_icon ad_common_rt" style="right: 8px"></div>
					<img style="margin-left: -8px;"
						src="images/testYourLove/20110126042753683.jpg"
						alt="《全城热恋》" width="160" height="110" /><a target="_blank"
						href="javascript:void(0)">我要报名</a>
				</div>
